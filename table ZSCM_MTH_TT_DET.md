# Table Definition: ZSCM_MTH_TT_DET

## Overview
Child/Detail table to store individual shipment details used for calculating monthly cumulative distance per Transport Truck/Vehicle. This table provides an audit trail and reference for the aggregated data in parent table ZSCM_MTH_TT_DIST.

## Table Relationship

```
ZSCM_MTH_TT_DIST (Parent - Aggregated Monthly Distance)
    │
    └── ZSCM_MTH_TT_DET (Child - Shipment Details)
...
|-------------|--------------|-------------------|
| ZSCM_MTH_TT_DIST | MANDT, VEHL_NO, GJAHR, MONAT | MANDT, VEHL_NO, GJAHR, MONAT |
...
2. Enter table name: ZSCM_MTH_TT_DET
3. Click Create
...
### Secondary Index: ZSCM_MTH_TT_DET~01
| Field | Description |
|-------|-------------|
| TKNUM | For lookup by shipment number |

### Secondary Index: ZSCM_MTH_TT_DET~02
| Field | Description |
|-------|-------------|
